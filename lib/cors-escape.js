...
function withCORS(headers, request) {
    headers['access-control-allow-origin'] = 'https://prod-normal-ryan.stackblitz.io';
...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
    console.log(`PROXY RESPONSE: ${proxyReq}`)
    console.log(`PROXY RESPONSE: ${JSON.stringify(proxyReq)}`)
